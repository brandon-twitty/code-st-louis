...
$metaDescription='Detailed use cases of how my direct decisions effected bottom line and ultimately transformed a business unit inside the manufacturing industry ';
?>
				...
				<div class="lx-single-work-body">
					<div class="lx-single-work-body-content">
						...
						<div class="lx-single-work-title">
							<h2>Introduction</h2>
							<p>Take a failing, newly bought <br />company by investors<br /> and make it profitable.</p>
						</div>
						<div class="lx-single-work-body-text">
                            <?php include_once('ma-project.php') ?>
