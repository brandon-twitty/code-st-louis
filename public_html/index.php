                        ...
                        <div class="row">
                            ...
                            <div class="table-cell col-md-5 text-right">
                                <div style="text-align:center;">
                                    <a class="typeform-share button" href="https://form.typeform.com/to/xjljHFMH?typeform-medium=embed-snippet"
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="icon-counter animated" data-fx="pulse">
                        ...
                        <span class="counter hr-mid" data-to="75">
                        0
                    </span>
    ...
    <section class="section bg2">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul class="media-list">
                        <li class="media feature-right-bottom square-icon-hover animated" data-fx="fadeInDown">
                ...
                <div class="col-md-4">
                    <ul class="media-list">
                        <li class="media feature-left-bottom square-icon-hover animated" data-fx="fadeInDown">
...
<script src="https://kit.fontawesome.com/a7e11e4cdb.js" crossorigin="anonymous"></script>
